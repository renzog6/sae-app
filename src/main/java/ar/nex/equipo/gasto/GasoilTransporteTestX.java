...
;
import ar.nex.equipo.transporte.*;
...
public class GasoilTransporteTestX extends Application {

    private final static Logger LOGGER = LogManager.getLogger(GasoilTransporteTestX.class.getName());

    @Override
    public void start(Stage stage) throws Exception {
        try {
            stage.setTitle("SAE-App");
            Parent root = new GasoilTransporteController().getRoot();
